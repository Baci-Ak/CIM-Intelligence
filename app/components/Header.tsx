...
import { onAuthStateChanged, signOut, User } from "firebase/auth"; // Import auth-related functions
          ...
          {user ? (
            ...
            <>
              <Link href="/auth/signup">
                <button className="bg-green-500 text-white px-2 py-1 rounded-md text-xs font-medium">Sign Up</button>
              </Link>
